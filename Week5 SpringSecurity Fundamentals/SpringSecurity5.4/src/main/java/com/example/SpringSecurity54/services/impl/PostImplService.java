...
import com.example.SpringSecurity54.repository.PostRepository;
import com.example.SpringSecurity54.services.PostService;
...
public class PostImplService implements PostService {
    ...
    public PostDto partialUpdatePost(Long id, Map<String, Object> map) {
        ...
        Post postToBeUpdated = postRepository.findById(id).orElseThrow(()-> new RuntimeException("Not found"));
        ...
        Post savdPost = postRepository.save(postToBeUpdated);

        return modelMapper.map(savdPost,PostDto.class);
    }
